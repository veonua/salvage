...
import com.jakewharton.salvage.IGrid;
 ...
 */
public class EqualGridLayout extends ViewGroup implements IGrid {
    ...
    public EqualGridLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EqualGridLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.EqualGridLayout, defStyle, 0);

        mNumColumns = a.getInt(R.styleable.EqualGridLayout_numColumns, 2);
        mNumRows = a.getInt(R.styleable.EqualGridLayout_numRows, 2);
